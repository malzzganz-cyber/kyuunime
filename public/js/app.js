/* ============================================================
   KyuuNime — app.js (No-Emoji Edition)
   ============================================================ */
...
function toggleAutoplay() {
  ...
  localStorage.setItem('KyuuNime_autoplay', JSON.stringify(autoplayEnabled));
...
function renderSettingPage(user) {
  ...
  const savedName = localStorage.getItem('KyuuNime_displayname') || user.displayName || 'KyuuNime User';
  ...
  wrap.innerHTML = `
    <div class="profile-card">
      ...
      <div class="profile-sub">MEMBER KYUUNIME</div>
    </div>
    <div class="setting-card" onclick="clearHistory()">
      <div class="setting-icon">${ICONS.trash}</div>
      <div class="setting-info"><div class="setting-title">Hapus Riwayat</div><div class="setting-desc">Bersihkan semua riwayat nonton</div></div>
...
async function saveProfile() {
  ...
  try {
    ...
    localStorage.setItem('kyuunime_displayname', nameVal.trim());
...
async function doRegister() {
  ...
  try {
    ...
    localStorage.setItem('KyuuNime_displayname', name);
...
// ============================================================
const HISTORY_KEY = 'kyuunime_history';
const PROGRESS_KEY = 'kyuunime_progress';
